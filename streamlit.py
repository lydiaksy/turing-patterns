...
if st.session_state["display_output"]:
    ...
    st.write("To begin, tweak the values of each parameter to generate a pattern that is unique to you
")
st.write("Tick ”spatial” if you’d like to generate a symmetrical pattern
